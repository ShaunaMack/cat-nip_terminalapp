...
# creates a new cat object then calls add_cat_to_shelter 
...
# takes shelters array (database) and new_cat object 
# adds the cat object to the correct shelter in the array (database)
# writes the file which holds the shelters array (database)
